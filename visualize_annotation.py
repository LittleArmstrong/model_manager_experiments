...
if __name__ == "__main__":
    ...
    create_annotated_folder_yolo("runs/testfall_3_augmentations/datasets/mosaic_var2")
    create_annotated_folder_yolo("runs/testfall_3_augmentations/datasets/mosaic_var3")